...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/itzhaolei@foxmail.com/ZLHTTPSessionManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'itzhaolei@foxmail.com' => 'itzhaolei@foxmail.com' }
  s.source           = { :git => 'https://github.com/itzhaolei@foxmail.com/ZLHTTPSessionManager.git', :tag => s.version.to_s }
